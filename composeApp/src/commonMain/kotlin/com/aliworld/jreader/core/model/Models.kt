...
@Serializable data class Chapter(val id:String,val mangaId:String,val source:SourceId,val number:String="",val title:String="",val scanlationGroup:String="",val pageLinks:List<String> = emptyList(),val language:String="")
